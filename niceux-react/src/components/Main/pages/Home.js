...
class Home extends Component {
    ...
    componentDidMount() {
    	...
    	let featureUrl = 'http://localhost:8888/NiceUX/Site/niceux/niceux-react/admin/wp-json/wp/v2/projects?featured_case_study=1';
        fetch(featureUrl)
        ...
        let articlesUrl = 'http://localhost:8888/NiceUX/Site/niceux/niceux-react/admin/wp-json/wp/v2/posts?per_page=4';
        fetch(articlesUrl)
        .then(response => response.json())
        .then(response => {
        	...
        	<div className="home">
	        	...
	        	<div className="container">
		        	<div className="about row">
		        		<h3>User Experience Design, Usability Research &amp; Frontend Engineering </h3>
